# Generated by Powerlevel10k configuration wizard on 2024-04-28 at 16:27 CEST.
...
() {
  ...
  # If set to false, hide haskprompt_exampleSSES is an array with even number of elements. The first element
  ...
  function prompt_example() {
    pacman_venv_name="$(echo $_PACMAN_VENV | awk -F'/' '{print $NF}')"

    if [[ -n "$pacman_venv_name" ]]; then
      p10k segment -b 1 -f 3 -i '⭐' -t "${pacman_venv_name}"
    fi
  }
